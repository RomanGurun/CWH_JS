...
,`See more Funny Thanksgiving Jokes.`
...
,`        Related: 100 Funny Easter Jokes for Kids`
...
let mat=Math.floor(Math.random()*200);

document.body.innerHTML="Joke for Your Happy Mood";

document.body.innerHTML=joke[mat];
document.body.innerHTML=joke[mat].style.color="red";
